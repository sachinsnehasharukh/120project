...
def preprocess_user_input(user_input):
    ...
    input_word_tokenize1=nltk.word_tokenize(user_input)

    # convert the user input into its root words : stemming
    input_word_tokenize2 = get_stem_words(input_word_tokenize1)

    # Remove duplicacy and sort the user_input
    input_word_tokenize3 = sorted(list(set(input_word_tokenize2)))
